...
class TokenizerProcessorStep(ObservationProcessorStep):
    ...
    def __post_init__(self):
        ...
        if self.tokenizer is not None:
            ...
            self.input_tokenizer = AutoTokenizer.from_pretrained('/data2/wyn/models/'+self.tokenizer_name)
        else:
            raise ValueError(
...
class ActionTokenizerProcessorStep(ActionProcessorStep):
    ...
    paligemma_tokenizer_name: str = "/data2/wyn/models/google/paligemma-3b-pt-224"
    # Internal tokenizer instance (not part of the config)
