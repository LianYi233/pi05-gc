...
class GR00TN15Config(PretrainedConfig):
    ...
    backbone_cfg: dict | None = field(default=None, init=False, metadata={"help": "Backbone configuration."})
    action_head_cfg: dict | None = field(default=None, init=False, metadata={"help": "Action head configuration."})
    action_horizon: int | None = field(default=None, init=False, metadata={"help": "Action horizon."})
    action_dim: int | None = field(default=None, init=False, metadata={"help": "Action dimension."})
