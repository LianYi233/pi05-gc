...
def eval_main(cfg: EvalPipelineConfig):
    ...
    base_for_print = policy
    if hasattr(policy, "model"):
        print("policy.model type:", type(policy.model))
        base_for_print = policy.model

    print("\n========== NAMED MODULES ==========")
    for name, module in base_for_print.named_modules():
        print(name, "->", type(module).__name__)

    print("\n========== NAMED PARAMETERS ==========")
    for name, param in base_for_print.named_parameters():
    ...
    if not found_lora:
        print("No LoRA parameters found in eval model.")
