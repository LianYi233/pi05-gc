...
huggingface_hub.utils.OfflineModeIsEnabled = True
...
#     local_dir="/media/wyn/data/10-EmbodiedAI/models/"
# )
import os
...
def main():
    ...
    model_id = "/media/wyn/data/10-EmbodiedAI/models/lerobot/pi05_base"
